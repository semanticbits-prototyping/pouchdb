...
function WebSqlPouch(opts, callback) {
  ...
  api.sbSetCryptKey = function (opts, callback) {
    if (opts.oldKey) {
      db._db._db.run(`PRAGMA KEY = '${opts.oldKey}';`, [], callback);
      db._db._db.run(`PRAGMA REKEY = '${opts.newKey}';`, [], callback);
    } else {
      db._db._db.run(`PRAGMA KEY = '${opts.newKey}';`, [], callback);
    }
  };
